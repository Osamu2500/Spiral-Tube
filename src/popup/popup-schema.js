        ...
        sections: [

            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'autoLike',         class:'span-3', label:'Auto Like', desc:'Automatically like video', icon:P('M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14z'), inlineSlot: `<div style="display:inline-flex; gap:6px; margin-left:8px; vertical-align:middle; z-index:10; position:relative;"><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeSubscribedOnly" style="font-size:10px; padding:3px 10px; border:1px solid rgba(255,255,255,0.08); border-radius:12px; cursor:pointer; color:inherit; background:rgba(255,255,255,0.04);" title="Subscribed Only">Subs</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeChannelLists" style="font-size:10px; padding:3px 10px; border:1px solid rgba(255,255,255,0.08); border-radius:12px; cursor:pointer; color:inherit; background:rgba(255,255,255,0.04);" title="Use Channel Lists">Lists</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeWaitAds" style="font-size:10px; padding:3px 10px; border:1px solid rgba(255,255,255,0.08); border-radius:12px; cursor:pointer; color:inherit; background:rgba(255,255,255,0.04);" title="Wait for Ads">Ads</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeHumanize" style="font-size:10px; padding:3px 10px; border:1px solid rgba(255,255,255,0.08); border-radius:12px; cursor:pointer; color:inherit; background:rgba(255,255,255,0.04);" title="Humanize Delay">Human</button><button type="button" id="autoLikeDelayTypeBtn" class="view-mode-btn" style="font-size:10px; padding:3px 10px; border:1px solid rgba(255,255,255,0.08); border-radius:12px; cursor:pointer; color:inherit; background:rgba(255,255,255,0.04);" title="Switch between Seconds / Percent">% / s</button></div><div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; margin-left:auto; gap:6px; padding-left: 10px; flex-grow:1; max-width:180px;"><input type="range" id="autoLikeThreshold" min="0" max="100" step="1" style="width:100%;"><span id="autoLikeThresholdValue" style="font-size:10px; min-width:32px; opacity:0.7; text-align:right;">0s</span></div><input type="hidden" id="autoLikeSubscribedOnly" /><input type="hidden" id="autoLikeChannelLists" /><input type="hidden" id="autoLikeWaitAds" /><input type="hidden" id="autoLikeHumanize" /><input type="hidden" id="autoLikeDelayType" value="seconds" />` },
