    ...
    // ──────────────────────────────────────────────────────────────────
    {
        ...
        sections: [
            ...
            },
            {
                title: 'Layout & Tools',
                items: [
                    { type:'toggle', id:'enableChannelHealth', class:'span-3', label:'Channel Health',  desc:'Scan for dead channels',        icon:P('M22 12h-4l-3 9L9 3l-3 9H2'), inlineSlot: `<div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; margin-left:auto; gap:6px; padding-left: 20px; flex-grow:1; max-width:160px;"><span style="font-size:10px; opacity:0.5;">Cols:</span><input type="range" id="channelColumnsUI" min="2" max="10" step="1" style="width:100%;"><span id="channelColumnsValue" style="font-size:10px; min-width:20px; opacity:0.7;">5</span></div><input type="hidden" id="channelColumns" value="5" />` },
                    { type:'toggle', id:'dummySubsGrid', class:'span-3 no-toggle', label:'Feed Grid Columns',  desc:'Grid layout size for subs', icon:P('M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z'), inlineSlot: `<div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; margin-left:auto; gap:6px; padding-left: 20px; flex-grow:1; max-width:160px;"><span style="font-size:10px; opacity:0.5;">Cols:</span><input type="range" id="subscriptionsColumnsUI" min="1" max="8" step="1" style="width:100%;"><span id="subscriptionsColumnsValue" style="font-size:10px; min-width:20px; opacity:0.7;">5</span></div><input type="hidden" id="subscriptionsColumns" value="5" />` }
                ]
            }
        ]
    },
