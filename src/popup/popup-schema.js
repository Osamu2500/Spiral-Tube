        ...
        sections: [
            ...
            // Section 1: Playback Automation & Behaviors
            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'autoPiP',          label: 'Auto PiP',           desc: t('auto_pip_desc'),              icon:P('M3 3h18v14H3zM12 14h7v5h-7z') },
            ...
            // Section 6: Custom Player Bar Placements
            {
                ...
                items: [
                    ...
                    { type:'button-group', id:'pb_pip', label: 'Auto PiP', desc: t('extension_feature'), icon:P('M3 3h18v14H3zM12 14h7v5h-7z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
