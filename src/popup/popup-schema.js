    ...
    // ──────────────────────────────────────────────────────────────────
    {
        ...
        sections: [
            ...
            // Section 6: Custom Player Bar Placements
            {
                ...
                items: [
                    { type:'button-group', class:'span-2', id:'pb_snapshot', label: t('snapshot_button'), desc: t('extension_feature'), icon:ICONS.snapshot, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_loop', label: t('loop_button'), desc: t('extension_feature'), icon:ICONS.loopButton, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_speed', label: t('speed_controls'), desc: t('extension_feature'), icon:P('M5 4l15 8-15 8V4z M19 5v14'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_bookmark', label: t('bookmark_button'), desc: t('extension_feature'), icon:ICONS.saveSupreme, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_pip', label: t('pip_button'), desc: t('extension_feature'), icon:P('M3 3h18v14H3zM12 14h7v5h-7z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_volume', label: t('volume_booster'), desc: t('extension_feature'), icon:ICONS.volumeUp, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_cinema', label: t('cinema_filters'), desc: t('extension_feature'), icon:ICONS.cinemaFilters, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_play', label: t('native_play_pause'), desc: t('youtube_feature'), icon:ICONS.player, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_next', label: t('native_next'), desc: t('youtube_feature'), icon:P('M5 4l10 8-10 8V4zM15 4h4v16h-4z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_mute', label: t('native_mute_volume'), desc: t('youtube_feature'), icon:P('M11 5L6 9H2v6h4l5 4V5zM15.54 8.46a5 5 0 0 1 0 7.07'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_cast', label: t('native_cast_tv'), desc: t('youtube_feature'), icon:P('M21 3H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z M1 18v3h3c0-1.66-1.34-3-3-3zM1 14v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7zM1 10v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_autoplay', label: t('native_autoplay'), desc: t('youtube_feature'), icon:ICONS.smartHistory, options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_cc', label: t('native_cc_subtitles'), desc: t('youtube_feature'), icon:P('M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 7H9.5v-.5h-2v3h2V13H11v1c0 .55-.45 1-1 1H7c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1zm7 0h-1.5v-.5h-2v3h2V13H18v1c0 .55-.45 1-1 1h-3c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_settings', label: t('native_settings'), desc: t('youtube_feature'), icon:P('M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06-.06a2 2 0 0 1-2.83-2.83l-.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06-.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_miniplayer', label: t('native_miniplayer'), desc: t('youtube_feature'), icon:P('M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zm-10-7h9v6h-9z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_theater', label: t('native_theater_mode'), desc: t('youtube_feature'), icon:P('M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                    { type:'button-group', class:'span-2', id:'pb_native_fullscreen', label: t('native_fullscreen'), desc: t('youtube_feature'), icon:P('M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z'), options: [{value:'front',label: t('front')},{value:'back',label: t('back')},{value:'hidden',label: t('hidden')}] },
                ]
            },
    ...
    // ──────────────────────────────────────────────────────────────────
    {
        ...
        sections: [
            ...
            },
            {
                ...
                icon: ICONS.keyboard,
                items: [
                    { type:'custom', id:'vsc_shortcuts_manager', class: 'span-4' }
                ]
            }
        ...
        sections: [
            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'hidePromoShelves',  label: t('hide_promos'),       desc: t('remove_shelves_games'),   icon:ICONS.promos },
                ]
            },
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'hidePlayerBranding', label: t('hide_player_branding'), desc: t('hide_player_branding_desc'), icon:ICONS.channelBar },
                    { type:'toggle', id:'hidePaidPromotion', label: t('hide_paid_promotion'), desc: t('hide_paid_promotion_desc'), icon:ICONS.promos }
                ]
            },
            {
                title: t('search_page'),
