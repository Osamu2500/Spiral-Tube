...
export const POPUP_SCHEMA = [
        ...
        sections: [

            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'autoLike',         class:'span-3', label:'Auto Like', desc:'Automatically like video', icon:P('M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14z'), bottomSlot: `<div style="display:flex; width:100%; flex-wrap:wrap; gap:12px; align-items:center; justify-content:space-between; margin-top: 8px;"><div style="display:inline-flex; background:rgba(255,255,255,0.06); border-radius:8px; overflow:hidden; z-index:10; position:relative;"><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeSubscribedOnly" style="font-size:11px; padding:4px 10px; border:none; cursor:pointer; color:inherit; background:none;" title="Subscribed Only">Subs</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeChannelLists" style="font-size:11px; padding:4px 10px; border:none; cursor:pointer; color:inherit; background:none;" title="Use Channel Lists">Lists</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeWaitAds" style="font-size:11px; padding:4px 10px; border:none; cursor:pointer; color:inherit; background:none;" title="Wait for Ads">Ads</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeHumanize" style="font-size:11px; padding:4px 10px; border:none; cursor:pointer; color:inherit; background:none;" title="Humanize Delay">Human</button></div><div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; gap:8px; flex-grow:1; max-width:240px; background:rgba(255,255,255,0.03); padding:4px 12px; border-radius:8px;"><button type="button" id="autoLikeDelayTypeBtn" class="view-mode-btn" style="font-size:11px; padding:0; border:none; cursor:pointer; color:inherit; background:none; font-weight:bold; min-width:16px; opacity:0.8;" title="Switch between Seconds / Percent">% / s</button><input type="range" id="autoLikeThreshold" min="0" max="100" step="1" style="width:100%; margin:0;"><span id="autoLikeThresholdValue" style="font-size:11px; min-width:32px; opacity:0.9; font-weight:bold; text-align:right;">0s</span></div></div><input type="hidden" id="autoLikeSubscribedOnly" /><input type="hidden" id="autoLikeChannelLists" /><input type="hidden" id="autoLikeWaitAds" /><input type="hidden" id="autoLikeHumanize" /><input type="hidden" id="autoLikeDelayType" value="seconds" />` },
        ...
        sections: [
            {
                ...
                icon: P('M4 6v12l8.5-6L4 6zm9 0v12l8.5-6L13 6z'),
                items: [
                    { type:'toggle', id:'enableCustomSpeed',  label:'Enable Controller', desc:'Master toggle', icon:P('M4 6v12l8.5-6L4 6zm9 0v12l8.5-6L13 6z') },
                    ...
                    { type:'toggle', id:'vscForceSpeed',    label:'Force Saved Speed', desc:'Prevent players from overriding', icon:P('M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM12 11.25V9c0-1.1-.9-2-2-2H8v8h2v-2.5h2v2.5h2V11.25zM10 9v1.25H8V9h2zm4 0v8h2V9h-2z') },
                ]
            },
            {
                ...
                items: [
                    { type:'toggle', id:'vscAudioSupport',  label:'Audio Support', desc:'Control <audio> tags', icon:P('M12 3v9.28a4.39 4.39 0 0 0-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7z') },
                    { type:'toggle', id:'vscRememberSpeed', label:'Remember Speed', desc:'Restore speed across videos', icon:P('M19 8l-4 4h3c0 3.31-2.69 6-6 6a5.87 5.87 0 0 1-2.8-.7l-1.46 1.46A7.93 7.93 0 0 0 12 20c4.42 0 8-3.58 8-8h3l-4-4zM6 12c0-3.31 2.69-6 6-6 1.01 0 1.97.25 2.8.7l1.46-1.46A7.93 7.93 0 0 0 12 4c-4.42 0-8 3.58-8 8H1l4 4 4-4H6z') },
                    { type:'toggle', id:'vscHideByDefault', label:'Hide by Default', desc:'Only show when changing speed', icon:P('M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.28 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z') },
                ]
            },
            {
                title: 'Shortcuts',
        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'enableFocusMode', label:'Focus Mode',      desc:'Hide all distractions on page',     icon:P('M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7') },
                    { type:'toggle', id:'minimalMode',     label:'Minimalist Chrome', desc:'Strip non-essential page chrome', icon:P('M9 3v18M3 9h6 M3 3h18v18H3z') },
                    { type:'toggle', id:'audioModeEnabled',label:'Audio-Only Mode', desc:'Listen only — hide the video',     icon:P('M9 18V5l12-2v13 M6 18a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M18 16a3 3 0 1 0 0-6 3 3 0 0 0 0 6z') }
                ]
            }
        ]
    },
        ...
        sections: [
            {
                ...
                items: [
                    ...
                    { type:'layoutToggle', id:'searchLayout',        label:'List View Size',      desc:'Linear search thumbnail size' },
    ...
    // ──────────────────────────────────────────────────────────────────
    {
        ...
        sections: [
            ...
            },
            {
                ...
                icon: P('M2 3h20v14H2zM8 21h8M12 17v4'),
                items: [
                    { type:'toggle', id:'hidePlayerTopics', label:'Hide Topics Bar',   desc:'Remove category chips',    icon:P('M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z M3.6 9h16.8 M3.6 15h16.8') },
    ...
    // ──────────────────────────────────────────────────────────────────
    { id: 'appearance', label: 'Design', icon: P('M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z'), custom: true, sections: [] },
    ...
    // ──────────────────────────────────────────────────────────────────
    {
        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    { type:'toggle', id:'returnYouTubeDislike', label:'Return YouTube Dislike', desc:'Restore dislike count via RYD API', icon:P('M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17') },
