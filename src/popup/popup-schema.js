        ...
        sections: [

            {
                ...
                items: [
                    ...
                    { type:'toggle', id:'autoLike',         class:'span-2', label:'Auto Like', desc:'Automatically like video', icon:P('M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14z'), inlineSlot: `<div style="display:inline-flex; background:rgba(255,255,255,0.06); border-radius:6px; overflow:hidden; margin-left:8px; vertical-align:middle; z-index:10; position:relative;"><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeSubscribedOnly" style="font-size:10px; padding:2px 8px; border:none; cursor:pointer; color:inherit; background:none;" title="Subscribed Only">Subs</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeChannelLists" style="font-size:10px; padding:2px 8px; border:none; cursor:pointer; color:inherit; background:none;" title="Use Channel Lists">Lists</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeWaitAds" style="font-size:10px; padding:2px 8px; border:none; cursor:pointer; color:inherit; background:none;" title="Wait for Ads">Ads</button><button type="button" class="view-mode-btn gpb-btn" data-target="autoLikeHumanize" style="font-size:10px; padding:2px 8px; border:none; cursor:pointer; color:inherit; background:none;" title="Humanize Delay">Human</button><button type="button" id="autoLikeDelayTypeBtn" class="view-mode-btn" style="font-size:10px; padding:2px 8px; border:none; border-left:1px solid rgba(255,255,255,0.1); cursor:pointer; color:inherit; background:rgba(255,255,255,0.05);" title="Switch between Seconds / Percent">% / s</button></div><div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; margin-left:auto; gap:6px; padding-left: 10px; flex-grow:1; max-width:140px;"><input type="range" id="autoLikeThreshold" min="0" max="100" step="1" style="width:100%;"><span id="autoLikeThresholdValue" style="font-size:10px; min-width:26px; opacity:0.7;">0s</span></div><input type="hidden" id="autoLikeSubscribedOnly" /><input type="hidden" id="autoLikeChannelLists" /><input type="hidden" id="autoLikeWaitAds" /><input type="hidden" id="autoLikeHumanize" /><input type="hidden" id="autoLikeDelayType" value="seconds" />` },
