      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            inlineSlot:
              '<div style="display:flex; align-items:center; width:100%; gap:16px; margin-top:10px; padding-top:10px; border-top:1px solid rgba(255,255,255,0.06);"><div style="display:flex; align-items:center; gap:12px; width:30%; max-width:180px;"><div class="inline-slider-wrapper" style="display:inline-flex; align-items:center; gap:6px; flex:1;"><span style="font-size:10px; opacity:0.5;">Min:</span><input type="range" id="viewsHideThresholdUI" min="0" max="11" step="1" style="flex:1; min-width:0;"><span id="viewsHideThresholdValue" style="font-size:11px; min-width:30px; opacity:0.8; font-weight:600;">Off</span></div></div><div style="display:flex; align-items:center; flex:1; gap:8px;"><span style="font-size:11px; opacity:0.6; font-weight:500; min-width:40px;">Pages:</span><div style="display:flex; align-items:center; flex:1; gap:8px;"><button type="button" class="theme-btn card-style-btn views-page-btn active" data-page="home" style="font-size:11px; padding:6px 0; flex:1; text-align:center; border-radius:6px; cursor:pointer; transition:all 0.2s;">Home</button><button type="button" class="theme-btn card-style-btn views-page-btn active" data-page="channel" style="font-size:11px; padding:6px 0; flex:1; text-align:center; border-radius:6px; cursor:pointer; transition:all 0.2s;">Channel</button><button type="button" class="theme-btn card-style-btn views-page-btn active" data-page="subs" style="font-size:11px; padding:6px 0; flex:1; text-align:center; border-radius:6px; cursor:pointer; transition:all 0.2s;">Subs</button><button type="button" class="theme-btn card-style-btn views-page-btn active" data-page="search" style="font-size:11px; padding:6px 0; flex:1; text-align:center; border-radius:6px; cursor:pointer; transition:all 0.2s;">Search</button><button type="button" class="theme-btn card-style-btn views-page-btn active" data-page="related" style="font-size:11px; padding:6px 0; flex:1; text-align:center; border-radius:6px; cursor:pointer; transition:all 0.2s;">Related</button></div></div></div><input type="hidden" id="viewsHideThreshold" value="0" />',
          },
          {
            type: 'toggle',
