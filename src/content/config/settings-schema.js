...
window.YPP.SettingsSchema = {
    ...
    schema: Object.freeze({
        ...
        activeTheme:         { type: 'string',  default: 'default', values: ['default','ocean','sunset','dracula','forest','midnight','cherry','system', 'coffee', 'cyberpunk', 'nord', 'discord', 'hacker', 'outrun', 'bloodmoon', 'deepspace', 'nebula', 'abyss', 'ember', 'hologram', 'blue-sky', 'retro', 'vintage', 'neumorphic', 'aurora', 'nature', 'technozen', 'terminalism', 'glassmorphism', 'material', 'maximalism', 'minimalism', 'claymorphism', 'brutalism', 'christmas', 'liquid-glass', 'frutiger-aero', 'pink', 'retrowave-green', 'harry-potter'] },
        ...
        cardStyle:           { type: 'string',  default: 'glass', values: ['anime', 'aurora', 'autumn', 'bento', 'compact', 'crystal-glass', 'cyberpunk', 'elevated', 'flat', 'folder', 'frosted', 'frutiger-aero', 'galaxy', 'glass', 'glassmorphism', 'gothic', 'grunge', 'harry-potter', 'hologram', 'holographic', 'immersive-glass', 'liquid-glass', 'material', 'matrix', 'maximalism', 'minimalism', 'minimalist', 'nature', 'neo-brutalism', 'neon', 'neumorphic', 'ocean', 'origami', 'polaroid', 'retro', 'retro-wave', 'skeuomorphic', 'spring', 'steampunk', 'summer', 'terminalism', 'vaporwave', 'vintage', 'winter', 'woodblock', 'y2k'] },
        ...
        copyLinkButton:      { type: 'boolean', default: true },
        ...
        popupUiTheme:        { type: 'string', default: 'liquid-glass', values: ['default', 'abyss', 'anime', 'aurora', 'autumn', 'bento', 'bloodmoon', 'blue-sky', 'brutalism', 'cairo-red', 'cherry', 'christmas', 'claymorphism', 'crystal-glass', 'cyberpunk', 'frutiger-aero', 'galaxy', 'glassmorphism', 'gothic', 'grunge', 'harry-potter', 'hologram', 'kawaii', 'liquid-glass', 'material', 'matrix', 'maximalism', 'minimalism', 'nature', 'neo-brutalism', 'neumorphic', 'ocean', 'origami', 'outrun', 'retro', 'retro-wave', 'steampunk', 'technozen', 'terminalism', 'vaporwave', 'vintage', 'woodblock', 'y2k'] },
        youtubePageTheme:    { type: 'string', default: 'default', values: ['default', 'abyss', 'anime', 'aurora', 'autumn', 'bento', 'bloodmoon', 'blue-sky', 'brutalism', 'cairo-red', 'cherry', 'christmas', 'claymorphism', 'colorize', 'crystal-glass', 'cyberpunk', 'deepspace', 'fluent', 'frutiger-aero', 'galaxy', 'glassmorphism', 'gothic', 'grunge', 'harry-potter', 'hologram', 'ice-blue', 'kawaii', 'liquid-glass', 'material', 'matrix', 'maximalism', 'minimalism', 'nature', 'nebula', 'neo-brutalism', 'neumorphic', 'ocean', 'origami', 'outrun', 'pink', 'player-retouch', 'retro', 'retro-wave', 'retrowave-green', 'startube', 'steampunk', 'technozen', 'terminalism', 'vaporwave', 'vintage', 'woodblock', 'y2k'] },
        cardStyle:           { type: 'string', default: 'glass', values: ['anime', 'aurora', 'autumn', 'bento', 'compact', 'crystal-glass', 'cyberpunk', 'elevated', 'flat', 'folder', 'frosted', 'frutiger-aero', 'galaxy', 'glass', 'glassmorphism', 'gothic', 'grunge', 'harry-potter', 'hologram', 'holographic', 'immersive-glass', 'liquid-glass', 'material', 'matrix', 'maximalism', 'minimalism', 'minimalist', 'nature', 'neo-brutalism', 'neon', 'neumorphic', 'ocean', 'origami', 'polaroid', 'retro', 'retro-wave', 'skeuomorphic', 'spring', 'steampunk', 'summer', 'terminalism', 'vaporwave', 'vintage', 'winter', 'woodblock', 'y2k'] },
