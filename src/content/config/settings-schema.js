...
window.YPP.SettingsSchema = {
    ...
    schema: Object.freeze({
        ...
        cardStyle:           { type: 'string',  default: 'glass', values: ['glass', 'flat', 'elevated', 'folder', 'bento', 'neon', 'compact', 'polaroid', 'neumorphic', 'cyberpunk', 'holographic', 'minimalist', 'retro', 'brutalism', 'skeuomorphic', 'frosted', 'summer', 'winter', 'spring', 'autumn', 'nature', 'vintage', 'ocean', 'blue-sky', 'immersive-glass', 'harry-potter'] },
        ...
        popupUiTheme:        { type: 'string', default: 'liquid-glass', values: ['default', 'christmas', 'liquid-glass', 'cyberpunk', 'neumorphic', 'minimal-flat', 'frutiger-aero', 'nature', 'vintage', 'ocean', 'blue-sky', 'retro', 'technozen', 'terminalism', 'claymorphism', 'brutalism', 'minimalism', 'maximalism', 'glassmorphism', 'aurora', 'material', 'harry-potter'] },
        youtubePageTheme:    { type: 'string', default: 'default', values: ['default', 'christmas', 'liquid-glass', 'crystal-glass', 'ice-blue', 'fluent', 'pink', 'retrowave-green', 'cairo-red', 'kawaii', 'colorize', 'player-retouch', 'cyberpunk', 'neumorphic', 'nature', 'vintage', 'ocean', 'blue-sky', 'retro', 'technozen', 'forest', 'frutiger-aero', 'terminalism', 'claymorphism', 'brutalism', 'minimalism', 'maximalism', 'glassmorphism', 'aurora', 'material', 'harry-potter', 'startube', 'cherry'] },
        cardStyle:           { type: 'string', default: 'glass', values: ['glass', 'flat', 'elevated', 'folder', 'bento', 'neon', 'compact', 'polaroid', 'neumorphic', 'cyberpunk', 'holographic', 'minimalist', 'maximalism', 'glassmorphism', 'crystal-glass', 'aurora', 'material', 'immersive-glass', 'retro', 'technozen', 'frutiger-aero', 'autumn', 'blue-sky', 'brutalism', 'claymorphism', 'frosted', 'minimalism', 'nature', 'ocean', 'skeuomorphic', 'spring', 'summer', 'terminalism', 'vintage', 'winter', 'harry-potter'] },
