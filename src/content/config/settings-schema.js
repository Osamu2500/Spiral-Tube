...
window.YPP.SettingsSchema = {
    ...
    schema: Object.freeze({
        ...
        activeTheme:         { type: 'string',  default: 'default', values: ['abyss', 'aurora', 'autumn', 'bento', 'bloodmoon', 'blue-sky', 'brutalism', 'cairo-red', 'cherry', 'christmas', 'claymorphism', 'coffee', 'colorize', 'crystal-glass', 'cyberpunk', 'deepspace', 'default', 'discord', 'dracula', 'ember', 'fluent', 'frutiger-aero', 'galaxy', 'glassmorphism', 'gothic', 'grunge', 'hacker', 'harry-potter', 'hologram', 'ice-blue', 'kawaii', 'liquid-glass', 'material', 'matrix', 'maximalism', 'midnight', 'minimalism', 'nature', 'nebula', 'neo-brutalism', 'neumorphic', 'nord', 'ocean', 'origami', 'outrun', 'pink', 'retro', 'retro-wave', 'retrowave-green', 'sakura', 'startube', 'steampunk', 'sunset', 'system', 'technozen', 'terminalism', 'vaporwave', 'vintage', 'woodblock', 'y2k'] },
        ...
        cardStyle:           { type: 'string',  default: 'glass', values: ['abyss','aurora','autumn','bento','bloodmoon','blue-sky','brutalism','cairo-red','cherry','christmas','claymorphism','coffee','colorize','compact','crystal-glass','cyberpunk','deepspace','discord','dracula','elevated','ember','flat','fluent','folder','frosted','frutiger-aero','galaxy','glass','glassmorphism','gothic','grunge','hacker','harry-potter','hologram','holographic','ice-blue','immersive-glass','kawaii','liquid-glass','material','matrix','maximalism','midnight','minimalism','minimalist','nature','nebula','neo-brutalism','neon','neumorphic','nord','ocean','origami','outrun','pink','polaroid','retro-wave','retro','retrowave-green','sakura','skeuomorphic','spring','steampunk','summer','sunset','technozen','terminalism','vaporwave','vintage','winter','woodblock','y2k'] },
