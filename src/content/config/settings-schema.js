...
window.YPP.SettingsSchema = {
    ...
    schema: Object.freeze({
        ...
        cardStyle:           { type: 'string',  default: 'glass', values: ['abyss','aurora','autumn','bloodmoon','blue-sky','brutalism','cairo-red','cherry','christmas','claymorphism','coffee','colorize','compact','crystal-glass','cyberpunk','deepspace','discord','dracula','elevated','ember','flat','fluent','folder','frosted','frutiger-aero','galaxy','glass','glassmorphism','gothic','grunge','hacker','harry-potter','hologram','holographic','ice-blue','immersive-glass','kawaii','liquid-glass','material','matrix','maximalism','midnight','minimalism','minimalist','nature','nebula','neo-brutalism','neon','neumorphic','nord','ocean','origami','outrun','pink','polaroid','retro-wave','retro','retrowave-green','sakura','skeuomorphic','spring','steampunk','summer','sunset','technozen','terminalism','vaporwave','vintage','winter','woodblock','y2k'] },
