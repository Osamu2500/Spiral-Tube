...
window.YPP.SettingsSchema = {
    ...
    schema: Object.freeze({
        ...
        popupUiTheme:        { type: 'string', default: 'liquid-glass', values: ['default', 'abyss', 'anime', 'aurora', 'autumn', 'bento', 'bloodmoon', 'blue-sky', 'brutalism', 'cairo-red', 'cherry', 'christmas', 'claymorphism', 'coffee', 'colorize', 'crystal-glass', 'cyberpunk', 'deepspace', 'discord', 'dracula', 'ember', 'fluent', 'forest', 'frutiger-aero', 'galaxy', 'glassmorphism', 'gothic', 'grunge', 'hacker', 'harry-potter', 'hologram', 'ice-blue', 'kawaii', 'liquid-glass', 'material', 'matrix', 'maximalism', 'midnight', 'minimalism', 'nature', 'nebula', 'neo-brutalism', 'neumorphic', 'nord', 'ocean', 'origami', 'outrun', 'pink', 'player-retouch', 'retro', 'retro-wave', 'retrowave-green', 'startube', 'steampunk', 'sunset', 'technozen', 'terminalism', 'vaporwave', 'vintage', 'woodblock', 'y2k'] },
        youtubePageTheme:    { type: 'string', default: 'default', values: ['default', 'abyss', 'anime', 'aurora', 'autumn', 'bento', 'bloodmoon', 'blue-sky', 'brutalism', 'cairo-red', 'cherry', 'christmas', 'claymorphism', 'coffee', 'colorize', 'crystal-glass', 'cyberpunk', 'deepspace', 'discord', 'dracula', 'ember', 'fluent', 'forest', 'frutiger-aero', 'galaxy', 'glassmorphism', 'gothic', 'grunge', 'hacker', 'harry-potter', 'hologram', 'ice-blue', 'kawaii', 'liquid-glass', 'material', 'matrix', 'maximalism', 'midnight', 'minimalism', 'nature', 'nebula', 'neo-brutalism', 'neumorphic', 'nord', 'ocean', 'origami', 'outrun', 'pink', 'player-retouch', 'retro', 'retro-wave', 'retrowave-green', 'startube', 'steampunk', 'sunset', 'system', 'technozen', 'terminalism', 'vaporwave', 'vintage', 'woodblock', 'y2k'] },
        cardStyle:           { type: 'string', default: 'glass', values: ['aurora', 'autumn', 'bento', 'compact', 'crystal-glass', 'cyberpunk', 'elevated', 'flat', 'folder', 'frosted', 'frutiger-aero', 'glass', 'glassmorphism', 'harry-potter', 'holographic', 'immersive-glass', 'liquid-glass', 'material', 'maximalism', 'minimalism', 'minimalist', 'nature', 'neon', 'neumorphic', 'ocean', 'polaroid', 'retro', 'skeuomorphic', 'spring', 'summer', 'terminalism', 'vintage', 'winter'] },
