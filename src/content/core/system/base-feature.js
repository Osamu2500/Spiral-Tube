...
window.YPP.features.BaseFeature = class BaseFeature {
    ...
    static allowInIframe = false; // Whether this feature is allowed to run inside the Popup Player
     ...
     */
    isPageAllowed() {
        // Prevent heavy features from running inside the Popup Player iframe
