...
export class PlayerSettingsMenu {
    ...
    injectSettingsMenuItems(menuElement, video) {
        ...
        for (const item of CONSTANTS.NATIVE_ITEMS) {
        ...
        if (this.player.settings.pb_speed === 'back') {
            _addSeparator();
            panelMenu.appendChild(this.createSettingsMenuItem('Custom Speed', CONSTANTS.ICONS.SPEED, () => {
        ...
        if (this.player.settings.pb_snapshot === 'back') {
            _addSeparator();
            panelMenu.appendChild(this.createSettingsMenuItem('Take Snapshot', CONSTANTS.ICONS.SNAPSHOT, () => {
        ...
        if (this.player.settings.pb_bookmark === 'back') {
            _addSeparator();
            panelMenu.appendChild(this.createSettingsMenuItem('Bookmark Highlight', CONSTANTS.ICONS.BOOKMARK, async () => {
        ...
        if (this.player.settings.pb_loop === 'back') {
            _addSeparator();
            panelMenu.appendChild(this.createSettingsMenuItem('Loop Video', CONSTANTS.ICONS.LOOP, () => { video.loop = !video.loop; }));
        }
        if (this.player.settings.pb_pip === 'back' && document.pictureInPictureEnabled) {
            _addSeparator();
            panelMenu.appendChild(this.createSettingsMenuItem('Picture-in-Picture', CONSTANTS.ICONS.PIP, async () => {
        ...
        if (this.player.settings.enableVolumeBoost && this.player.settings.pb_volume === 'back') {
            ...
            if (volumeFeature) {
                panelMenu.appendChild(this.createSettingsMenuItem('Volume Booster', CONSTANTS.ICONS.VOLUME, (e) => {
        ...
        if (this.player.settings.enableCinemaFilters && this.player.settings.pb_cinema === 'back') {
            ...
            if (filterFeature) {
                panelMenu.appendChild(this.createSettingsMenuItem('Cinema Filters', CONSTANTS.ICONS.CINEMA, (e) => {
