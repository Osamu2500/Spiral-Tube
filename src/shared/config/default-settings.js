export const DEFAULT_SETTINGS = {
  ...
  contextMenuWindowMode: true,
  contextMenuMusicMode: true,
  contextMenuOpenNewTab: true,
  contextMenuOpenThumbnail: true,
  contextMenuCopyUrl: true,
  quickAccessVisibilityEditor: true,
  quickAccessPopupMode: true,
  quickAccessAspectRatio: true,
  quickAccessPopupSize: true,
  quickAccessMiniplayerSize: true,
  quickAccessMiniplayerPosition: true,
  quickAccessPlayerOnly: true,
  ...
  floatingSearchCloseOnBackdropClick: false,
  toolbarVisibilityEditor: true,
  toolbarOpenWatchPage: true,
  ...
  autoShortsRatio: false,
  autoRedirectShortsToWatch: false,
  playerOnly: false,
  volumeBoostEnabled: false,
  volumeBoostLevel: 100,
  youtubeScreenshotButton: false,
  minimalModeDebug: false,
  minimalHomeNavVisibilityEditor: true,
  minimalHomeNavYourFeed: true,
  minimalHomeNavHistory: true,
  minimalHomeNavPlaylists: true,
  minimalHomeNavWatchLater: true,
  minimalHomeNavLikedVideos: true,
  minimalHomeNavPodcasts: true,
  minimalHomeNavClips: true,
  youtubeGridItemsPerRow: 3,
  ...
  viewsFilterChannel: true,
  viewsFilterRelated: true,
  dateFilterHome: true,
  dateFilterSubs: true,
  dateFilterSearch: true,
  dateFilterChannel: true,
  dateFilterRelated: true,
