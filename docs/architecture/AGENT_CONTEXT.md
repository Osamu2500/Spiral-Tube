...
- Basically just SOPs written in Markdown, live in `docs/`
...
- You're the glue between intent and execution.
  E.g. you don't try scraping websites yourself — you read `DIRECTIVE_TEMPLATE.md` (or similar), come up with inputs/outputs, and then run `execution/scrape_single_site.py`
...
docs/               # SOPs in Markdown (the instruction set)
